...
public class Polygons {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        Integer[][] inputs = { { 36, 30, 36, 30 }, { 15, 15, 15, 15 }, { 46, 96, 90, 100 }, { 86, 86, 86, 86 },
                { 100, 200, 100, 200 }, { -100, 200, -100, 200 } };

        if (DBG)
            System.out.println("Input: " + inputs.length);
        ...
        for (int i = 0; i < inputs.length; i++) {
            ...
            if (temp[0] == temp[1] && temp[1] == temp[2] && temp[2] == temp[3] && temp[3] == temp[0]) {
                ...
                if (DBG)
                    System.out.println("It's square: " + temp[0] + " " + temp[1] + " " + temp[2] + " " + temp[3]);
                squareCount += 1;
                ...
                if (DBG)
                    System.out.println(
                            "size: " + temp2.size() + " - " + temp[0] + " " + temp[1] + " " + temp[2] + " " + temp[3]);

                if (temp2.size() == 2 && temp[0] > 0 && temp[1] > 0 && temp[2] > 0 && temp[3] > 0) {
                    rectangleCount += 1;
                    if (DBG)
                        System.out
                                .println("It's rectangle: " + temp[0] + " " + temp[1] + " " + temp[2] + " " + temp[3]);
                } else {
                    if (DBG)
                        System.out.println("It's other: " + temp[0] + " " + temp[1] + " " + temp[2] + " " + temp[3]);
                    others += 1;
                }
            }
