...
public class no0704_Binary_Search {
    ...
    public static void main(String[] args) {
        ...
        int[][] testCases = {{-1, 0, 3, 5, 9, 12},    // Regular test case
        ...
        for (int i = 0; i < testCases.length; i++) {
            ...
            System.out.println("Array: " + java.util.Arrays.toString(testCases[i]) + ", Target: " + targets[i] + " | Output: " + result + " | Expected: " + expected[i] + " | " + (result == expected[i] ? "✓ PASS" : "✗ FAIL"));
        }
    }
}
